...
from items.views_fold import items_views as item
from items.views_fold import bid_views as bid
...
urlpatterns = patterns('',
    ...
    url('^', include('django.contrib.auth.urls')),
                       ...
                       url(r'^login_message/', user.login_message),
                       url(r'^add_bid/', bid.add_bid),
                       url(r'^del_bid/', bid.del_bids),
                       url(r'^view_bids/', bid.view_bids),
                       )
